...
public class SFtpUtil {
	//测试环境
//	private String IP = "192.168.1.226";//IP
//	
//    private int PORT = 22;//端口
//    
//    private String USERNAME = "web";//用户名
//    
//    private String PASSWORD = "web123";//密码
    
  //测试环境
  	  private String IP = "172.16.138.228";//IP
  	
      private int PORT = 22;//端口
      
      private String USERNAME = "web";//用户名
      
      private String PASSWORD = "wTDev]sb@-39";//密码
    
    //正式环境
//	private String IP = "172.16.138.230";//IP
//	
//    private int PORT = 22;//端口
//
//    private String USERNAME = "web";//用户名
