...
public class HttpClientUtil {
    ...
    static {
        config = RequestConfig.custom().setConnectTimeout(120000).setSocketTimeout(120000).build();
    }
    ...
    public static String doPost(Map<String, String> params,String url,String contentType){
        return doPost(params,url,DEFAULT_SEND_CHARSET,DEFAULT_RES_CHARSET,contentType);
    }
    public static String doRestPost(String params,String url,String contentType){
        return doRestPost(params,url,DEFAULT_SEND_CHARSET,DEFAULT_RES_CHARSET,contentType);
    }    
  ...
  public static String doRestPost(String jsonStr,String url,String reqCharset,String resCharset,String contentType){
	  	CloseableHttpClient httpClient = getSingleSSLConnection();
	   	CloseableHttpResponse response = null;
	      if(StringUtils.isBlank(url)){
	          return null;
