...
public interface DrClaimsLoanDAO {
	 ...
	 * @return
	 */
	public DrClaimsLoan getDrClaimsLoanBySidB(Integer sid);
	
	public List<Map<String,Object>>  selectDrClaimsScore();
	
	public List<Map<String,Object>>  selectDrClaimsCreditCertification();
	
	public List<Map<String,Object>>  selectDrClaimsRiskRating();
