...
public class FuiouOnlineBanking12Req extends BaseReqdata{
	private String login_id ="";//用户登录名
	private String amt ="";//充值金额
	private String order_pay_type="";//m支付类型
	private String iss_ins_cd="";//m银行代码
	private String page_notify_url ="";//商户返回地址
	private String back_notify_url ="";//商户后台调用地址
	
	public FuiouOnlineBanking12Req() {
		super();
	}
	
	public FuiouOnlineBanking12Req(String login_id, String amt, String page_notify_url, String back_notify_url) {
		super();
